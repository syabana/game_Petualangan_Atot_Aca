Public Class perjogja
    ...
    Private Sub perjogja_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Label4.Text = n.scor
    End Sub
End Class