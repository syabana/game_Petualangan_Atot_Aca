Public Class perjatim
    Public intRandomNumber As Integer = 0
    Private n As New nilai

    Private Sub perjatim_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Label4.Text = n.scor
    End Sub
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        pert1.pertjatim(intRandomNumber)
        If n.benar = 15 Then
            Me.Hide()
            jatim.Show()
        End If
